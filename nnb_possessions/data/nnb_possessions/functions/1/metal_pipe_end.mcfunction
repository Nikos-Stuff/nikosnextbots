...
stopsound @a[scores={nn_possesion=1},tag=nextbot_timeout] * vibecraft:possession
...
scoreboard players set @a[scores={nn_possesion=1},tag=nextbot_timeout] nn_possesion 0
