kill @e[tag=unfortunate]
stopsound @a[tag=nextbot_timeout] * vibecraft:possession
tag @a[scores={nn_possesion=44},tag=nextbot_timeout] remove nextbot
tag @a[scores={nn_possesion=44},tag=nextbot_timeout] remove unfortunate_z
