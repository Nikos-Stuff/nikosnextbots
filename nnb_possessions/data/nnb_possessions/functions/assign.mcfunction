...
execute at @e[type=minecraft:zombie,tag=metalic_pipe_z] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 1
execute at @e[type=minecraft:zombie,tag=metalic_pipe_z] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=metalic_pipe_z] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
