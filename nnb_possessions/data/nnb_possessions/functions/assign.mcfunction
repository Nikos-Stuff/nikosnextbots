...
#> Reset on timeout
execute if entity @a[scores={nn_possesion=1},tag=nextbot_timeout] run function nnb_possessions:1/metalic_pipe_end

#> Teleport sprite and assign tags
execute if entity @a[scores={nn_possesion=1},tag=!nextbot_timeout] run tag @a[scores={nn_possesion=1},tag=!nextbot_timeout] add metalic_pipe_z
execute at @a[tag=metalic_pipe_z] run tp @e[tag=metalic_pipe] ~ ~2 ~

#> Screen effects tag
tag @a[tag=metalic_pipe_z] add n_nextbot
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 2
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 3
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 4
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 5
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 6
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 7
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 8
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 9
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 10
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 11
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 12
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 13
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 14
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 15
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 16
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 17
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 18
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Screen effects tag
tag @a[tag=chilly_z] add n_nextbot
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 19
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 20
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 21
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 22
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 23
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 24
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 25
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 26
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 27
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 28
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 29
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
execute at @a[scores={nn_possesion=29}] run tag @p add nextbot

#> Reset on timeout
execute if entity @a[scores={nn_possesion=29},tag=nextbot_timeout] run function nnb_possessions:29/nuke_end

#> Teleport sprite and assign tags
execute if entity @a[scores={nn_possesion=29},tag=!nextbot_timeout] run tag @a[scores={nn_possesion=29},tag=!nextbot_timeout] add nuke_z
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 30
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
execute at @a[scores={nn_possesion=30}] run tag @p add nextbot

#> Reset on timeout
execute if entity @a[scores={nn_possesion=30},tag=nextbot_timeout] run function nnb_possessions:30/nothing_end

#> Teleport sprite and assign tags
execute if entity @a[scores={nn_possesion=30},tag=!nextbot_timeout] run tag @a[scores={nn_possesion=30},tag=!nextbot_timeout] add nothing_z
execute at @a[tag=nothing_z] run tp @e[tag=nothing] ~ ~2 ~

#> Screen effects tag
tag @a[tag=nothing_z] add n_nextbot
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 31
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 32
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 33
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 34
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 35
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 36
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 37
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 38
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 39
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 40
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 41
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 42
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 43
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 44
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 45
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 46
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 47
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 48
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 49
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 50
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 51
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 52
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
...
#> Detect and assign possession
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run execute at @a[distance=..5.5,sort=nearest,tag=!nextbot] run scoreboard players set @p nn_possesion 53
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run tag @e[type=zombie,limit=1,distance=..1.1] add controled
execute at @e[type=minecraft:zombie,tag=nextbot] if entity @e[type=minecraft:snowball,distance=..2.2] run kill @e[tag=controled,distance=..1.1,limit=1]
