...
#> Reset on timeout
execute if entity @a[scores={nn_possesion=60},tag=nextbot_timeout] run function nnb_possessions:60/egg_end

#> Teleport sprite and assign tags
execute if entity @a[scores={nn_possesion=60},tag=!nextbot_timeout] run tag @a[scores={nn_possesion=60},tag=!nextbot_timeout] add egg_z
